...
export const TESTIMONIALS_LANDING = [
  ...
  { name: 'James C.', role: 'Senior Architect', location: 'New York, USA', content: 'Having AutoCAD, SketchUp, Lumion and D5 Render in one bundle is genius. My studio now uses the full pipeline — plan, design, animate, render — to generate gorgeous client presentations in minutes. Best €39 our firm ever invested.' },
  ...
  { name: 'Olivia B.', role: 'Interior Designer', location: 'Sydney, Australia', content: 'To have someone look at your screen and say "press this button" saves weeks of frustration. AutoCAD for planning, SketchUp for designing, Lumion & D5 for rendering. All for €39.' },
  ...
  { name: 'Alex D.', role: 'Architect & Educator', location: 'Barcelona, Spain', content: 'Universities don\'t teach this pipeline. AutoCAD + SketchUp + Lumion + D5 Render AI is what the industry actually uses. I recommend this €39 bundle to all my students — it\'s more practical than their entire semester.' },
];

export const FAQ_ITEMS_LANDING = [
  { question: "What exactly do I get for €39?", answer: "You get 4 complete courses: AutoCAD (professional 2D floor plans & drafting), SketchUp Pro (3D modeling from scratch), Lumion Cinematic (video walkthroughs & animations), and D5 Render AI (real-time AI rendering). Plus 10,000+ textures, 2,000+ 3D models, all software download links, a certified diploma, and 24/7 team support. Lifetime access, one-time payment." },
  ...
  { question: "What if it's not for me?", answer: "We offer a 100% money-back guarantee within 7 days. If you feel it's not a good fit, just email us and we'll refund your €39 immediately — no questions asked. Zero risk." },
];
